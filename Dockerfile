...
RUN mkdir /temp/BAR/
RUN chown -R aceuser:aceuser /temp/BAR/
COPY ./acesoe/binary/Microservice2.bar /temp/BAR
...
RUN bash -c 'mqsibar -w /home/aceuser/ace-server -a /temp/BAR/Microservice2.bar -c'
#USER aceuser
